...
def DataTransfer():
    ...
    for dataT in range(output_q.qSize()):
        ...
        #Add a new parameter "Current_Count" which will be used for batched reading in specific order
        #The reason why we added this counter parameter now is to avoid the issues with batched writing to server
        #This is the only time where each document is written separately.
        #
        # 
        ...
        #currentVal["ID"].update(current_count)
